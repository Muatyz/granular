...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
index_filtered = 20; %%% 由于信噪比过低, 在分析波前时需要被提前滤去
...
freq_c = 130e3; freq_halfwidth = 3e3;
...
efficiency = 3.75233; %%% the response factor at f_c = 130 kHz
...
time_window = 0.35; % Typical time length of the wave train. The unit is ms
index_start = index_filtered + 1;
index_len = num - index_filtered; % 真正可供分析的数据矢量长度
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
time_wavefront_amp_start = 3.2285; %%% 序号为 index_start 的波列估计的波前时间. The unit is ms
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
